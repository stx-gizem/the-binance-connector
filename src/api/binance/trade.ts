...
class TradeApi extends BinanceApi {
  /**
   ...
   * @param {number} [options.recvWindow] - The value cannot be greater than 60000
   */
  openOrders(options: OpenOrdersOptions = {}, config: ConfigOptions = {}) {
    return this.signRequest('GET', '/api/v3/openOrders', options, config);
  }
   ...
   * @param {number} [options.recvWindow] - The value cannot be greater than 60000
   */
  getOCOOrder(options: GetOCOOrderOptions = {}, config: ConfigOptions = {}) {
    return this.signRequest('GET', '/api/v3/orderList', options, config);
  }
   ...
   * @param {number} [options.recvWindow] - The value cannot be greater than 60000
   */
  getOCOOrders(options: GetOCOOrdersOptions = {}, config: ConfigOptions = {}) {
    return this.signRequest('GET', '/api/v3/allOrderList', options, config);
  }
   ...
   * @param {number} [options.recvWindow] - The value cannot be greater than 60000
   */
  getOpenOCOOrders(options: RecvWindowOption = {}, config: ConfigOptions = {}) {
    return this.signRequest('GET', '/api/v3/openOrderList', options, config);
  }
   ...
   * @param {number} [options.recvWindow] - The value cannot be greater than 60000
   */
  account(options: RecvWindowOption = {}, config: ConfigOptions = {}) {
    return this.signRequest('GET', '/api/v3/account', options, config);
  }
...
export const Trade = new TradeApi();
