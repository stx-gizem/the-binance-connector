...
import {
  FuturesLoanBorrowHistoryOptions,
  FuturesLoanConfigsOptions,
  FuturesLoanHistoryOptions,
  FuturesLoanInterestHistoryOptions,
  FuturesLoanRepayHistoryOptions,
  FuturesTransferHistoryOptions,
} from '../../@types/futures';

class FuturesApi extends BinanceApi {
  /**
   ...
   * @param {number} [options.recvWindow]
   */
  futuresLoanBorrowHistory(
    options: FuturesLoanBorrowHistoryOptions = {},
    config: ConfigOptions = {},
  ) {
    return this.signRequest(
      'GET',
   ...
   * @param {number} [options.recvWindow]
   */
  futuresLoanRepayHistory(
    options: FuturesLoanRepayHistoryOptions = {},
    config: ConfigOptions = {},
  ) {
    return this.signRequest(
      'GET',
   ...
   */
  futuresLoanConfigs(
    options: FuturesLoanConfigsOptions = {},
    config: ConfigOptions = {},
  ) {
    return this.signRequest(
      'GET',
   ...
   */
  futuresLoanAdjustCollateralHistory(
    options: FuturesLoanHistoryOptions = {},
    config: ConfigOptions = {},
  ) {
    return this.signRequest(
      'GET',
   ...
   * @param {number} [options.recvWindow]
   */
  futuresLoanInterestHistory(
    options: FuturesLoanInterestHistoryOptions = {},
    config: ConfigOptions = {},
  ) {
    return this.signRequest(
      'GET',
...
export const Futures = new FuturesApi();
