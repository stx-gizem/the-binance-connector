...
export class UsdMFuturesApi extends ApiBase {
  ...
  protected publicRequest<R = any>(method: Method, path: string, params: {} = {}, config?: ConfigOptions, endpoint: ApiUrl = ApiUrl.FAPI): Promise<AxiosResponse> {
    return super.publicRequest(method, path, params, config, endpoint);
  }

  protected signRequest<R = any>(method: Method, path: string, params: {} = {}, config?: ConfigOptions, endpoint: ApiUrl = ApiUrl.FAPI): Promise<AxiosResponse> {
